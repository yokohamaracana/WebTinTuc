					...
					<div class="a-1">
						...
						<div class="row">
							<div class="col-md-6 abt-left">
								<a href="<?php echo e(asset('single')); ?>"><img src="<?php echo e(asset('uploads/'.$value->image)); ?>" alt="" /></a>
							</div>
							<div class="col-md-6 abt-left">
								<h6>Find The Most</h6>
								<h3><a href="<?php echo e(asset('single')); ?>"><?php echo e($value->title); ?></a></h3>
								<p><?php echo $value->short_desc; ?></p>
								<label>May 29, 2015</label>
								<a class="abt-2" href="<?php echo e(asset('single')); ?>">Read More</a>
							</div>
						</div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Coffe\resources\views/pages/index.blade.php ENDPATH**/ ?>